...
void Blackjack::checkForGameover() {
	...
	// Checks if the User wants to forcefully quit the game -- if so sets gameover to true, if gameover already true then code inside does not get executed
